...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Small gem for generating a Metallica like logo for some provided string}
  spec.description   = %q{This gem uses an existing logo generation API to generate a Metallica like logo for a given string}
